...
Functions: `definition` (L20-L27), `default_params` (L29-L36), `param_specs` (L38-L59), `compute` (L61-L65), `apply_to_geometry` (L67-L143), `cutter_inner_surface` (L145-L180), `boolean_mesh_mesh` (L182-L228), `try_trivial_boolean` (L230-L273), `containment_flags` (L275-L275), `flatten_positions` (L293-L301), `has_sdf_volume` (L303-L305), `find_sdf_volume` (L307-L309), `clip_mesh_with_sdf` (L311-L479), `build_polygon_samples` (L481-L516), `manifold_from_mesh` (L518-L621), `quantize_position` (L623-L623), `bounding_center` (L632-L632), `append_mesh_with_defaults` (L646-L730), `extend_attribute_storage` (L732-L756), `build_triangle_list` (L765-L775), `is_inside_mesh` (L777-L782), `winding_number` (L784-L804), `clip_polygon` (L812-L837), `clip_intersection` (L839-L847), `new` (L862-L920), `transfer_attributes_from_sources` (L930-L998), `build_point_samples` (L1000-L1006), `build_corner_samples` (L1008-L1017), `build_prim_samples` (L1019-L1028), `nearest_triangle` (L1030-L1059), `distance2_point_aabb` (L1061-L1068), `transfer_domain_attributes` (L1070-L1165), `transfer_detail_attributes` (L1167-L1178), `collect_attribute_schema` (L1180-L1206), `register_attr` (L1208-L1226), `push` (L1236-L1246), `sample_float` (L1249-L1271), `sample_int` (L1273-L1297), `sample_vec2` (L1299-L1304), `sample_vec3` (L1337-L1342), `sample_vec4` (L1361-L1366), `sample_string` (L1385-L1409), `transfer_groups` (L1411-L1433), `sample_group` (L1435-L1462), `mesh_attribute_indices` (L1464-L1468), `sample_face_index` (L1486-L1488), `barycentric_max_index` (L1490-L1490), `lerp_f32` (L1503-L1503), `lerp_vec2` (L1510-L1511), `lerp_vec3` (L1524-L1525), `lerp_vec4` (L1539-L1540), `closest_point_on_triangle` (L1555-L1555)
