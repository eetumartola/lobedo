...
Functions: `geometry_in` (L73-L78), `geometry_out` (L80-L85), `require_mesh_input` (L87-L96), `recompute_mesh_normals` (L98-L119), `selection_shape_params` (L121-L137)
...
Functions: `id` (L76-L78), `builtin_kind_from_id` (L81-L85), `mesh_error_read_splats` (L109-L111), `mesh_error_curve` (L113-L115), `mesh_error_volume_blur` (L117-L119), `mesh_error_sweep` (L121-L123), `mesh_error_write_splats` (L125-L127), `mesh_error_splat_to_mesh` (L129-L131), `mesh_error_volume_from_geo` (L133-L135), `mesh_error_volume_from_splats` (L137-L139), `mesh_error_volume_combine` (L141-L143), `mesh_error_volume_to_mesh` (L145-L147), `mesh_error_attribute_from_volume` (L149-L151), `node_specs` (L1010-L1012), `menu_group` (L1014-L1016), `node_spec` (L1018-L1023), `input_policy` (L1025-L1027), `name` (L1030-L1032), `builtin_kind_from_name` (L1036-L1044), `builtin_definitions` (L1046-L1051), `node_definition` (L1053-L1055), `default_params` (L1057-L1059), `param_specs` (L1061-L1063), `param_specs_for_name` (L1065-L1069), `param_specs_for_kind_id` (L1071-L1075), `compute_mesh_node` (L1077-L1083), `compute_geometry_node` (L1085-L1091), `compute_geometry_box` (L1093-L1095), `compute_geometry_grid` (L1097-L1099), `compute_geometry_sphere` (L1101-L1103), `compute_geometry_tube` (L1105-L1107), `compute_geometry_circle` (L1109-L1111), `compute_geometry_curve` (L1113-L1116), `compute_geometry_file` (L1118-L1120), `compute_geometry_read_splats` (L1122-L1127), `compute_geometry_merge` (L1129-L1131), `compute_geometry_output` (L1133-L1135), `compute_geometry_normal` (L1137-L1139), `compute_geometry_color` (L1141-L1143), `compute_geometry_noise` (L1145-L1147), `compute_geometry_erosion_noise` (L1149-L1154), `compute_geometry_smooth` (L1156-L1158), `compute_geometry_uv_texture` (L1160-L1165), `compute_geometry_uv_unwrap` (L1167-L1172), `compute_geometry_uv_view` (L1174-L1176), `compute_geometry_attribute_noise` (L1178-L1183), `compute_geometry_attribute_promote` (L1185-L1190), `compute_geometry_attribute_expand` (L1192-L1197), `compute_geometry_attribute_from_feature` (L1199-L1204), `compute_geometry_attribute_math` (L1206-L1211), `compute_splat_node` (L1213-L1219), `compute_splat_read_splats` (L1221-L1226), `splat_error_not_output` (L1228-L1233), `apply_mesh_unary` (L1235-L1304), `apply_splat_only` (L1306-L1345), `apply_attribute_transfer` (L1347-L1352), `apply_delete` (L1354-L1386), `apply_prune` (L1388-L1392), `apply_regularize` (L1394-L1398), `apply_splat_lod` (L1400-L1404), `apply_splat_heal` (L1406-L1408), `apply_splat_outlier` (L1410-L1414), `apply_splat_cluster` (L1416-L1420), `apply_splat_delight` (L1422-L1424), `filter_splats` (L1426-L1446), `apply_group` (L1448-L1477), `apply_group_expand` (L1479-L1508), `apply_transform` (L1510-L1552), `apply_copy_transform` (L1554-L1618), `apply_copy_to_points` (L1620-L1674), `apply_obj_output` (L1676-L1690), `apply_write_splats` (L1692-L1701), `merge_geometry` (L1703-L1713), `transform_applies_scale` (L1723-L1731), `merge_combines_meshes` (L1734-L1740), `scatter_produces_points` (L1743-L1755), `normal_recomputes_normals` (L1758-L1764), `node_specs_cover_definitions` (L1767-L1769), `node_spec_ids_are_unique` (L1772-L1777)
