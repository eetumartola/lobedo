...
pub mod f32 {
    ...
    use super::f64;
    #[cfg(all(any(target_arch = "x86", target_arch = "x86_64"), feature = "std"))]
    pub use crate::{simd::*, simd_primitives::f32x8};
    #[cfg(all(
        any(target_arch = "x86", target_arch = "x86_64"),
        feature = "std",
        feature = "avx512"
    ))]
    pub use crate::simd_primitives::f32x16;
...
pub mod f64 {
    ...
    use super::f32;
    #[cfg(all(any(target_arch = "x86", target_arch = "x86_64"), feature = "std"))]
    pub use crate::{simd::*, simd_primitives::f64x4};
    #[cfg(all(
        any(target_arch = "x86", target_arch = "x86_64"),
        feature = "std",
        feature = "avx512"
    ))]
    pub use crate::simd_primitives::f64x8;
