    ...
    match node_name {
        ...
        "Splat Read" | "Read Splats" => Some(NodeHelpPage {
            ...
            description: &[
                ...
                "Data is validated and normalized on load to keep scales, opacities, and SH coefficients stable.",
                "Color Only mode skips higher-order SH data for faster loading and smaller memory use.",
            ],
            inputs: &[],
            outputs: &["out: Splat geometry."],
            parameters: &[
                ("path", "Path to a splat PLY file."),
                ("read_mode", "Read mode: Full SH or Color Only."),
            ],
        }),
        "Splat Write" | "Write Splats" => Some(NodeHelpPage {
            name: "Splat Write",
            description: &[
                "Writes Gaussian splats to a PLY file.",
                "The node passes geometry through; writing happens only when the Write button is pressed.",
                "Binary is faster and smaller, ASCII is useful for debugging.",
            ],
            inputs: &["in: Splat geometry to write."],
            outputs: &["out: Pass-through geometry."],
            parameters: &[
                ("path", "Output PLY file path."),
                ("format", "PLY format: Binary or ASCII."),
            ],
        }),
        ...
        "Splat Prune" | "Prune" => Some(NodeHelpPage {
            name: "Splat Prune",
            description: &[
                "Filters splats by log-scale and logit-opacity ranges.",
            ...
            parameters: &[
                ("min_opacity", "Minimum log-opacity to keep."),
                ("max_opacity", "Maximum log-opacity to keep."),
                ("min_scale", "Minimum log-scale to keep."),
                ("max_scale", "Maximum log-scale to keep."),
        ...
        "Splat Regularize" | "Regularize" => Some(NodeHelpPage {
            ...
            description: &[
                "Clamps splat parameters to a stable range and optionally normalizes them.",
            ...
            parameters: &[
                ("min_scale", "Minimum log-scale to keep."),
                ("max_scale", "Maximum log-scale to keep."),
                ("normalize_opacity", "Renormalize opacity to a stable range."),
                ("normalize_rotation", "Normalize/repair rotations."),
                ("remove_invalid", "Drop splats with NaN/Inf."),
            ],
        }),
        "Splat LOD" => Some(NodeHelpPage {
            ...
            description: &[
                ...
                "Each voxel keeps a representative splat, preserving overall shape at lower cost.",
        ...
        "Splat to Mesh" => Some(NodeHelpPage {
            ...
            description: &[
                ...
                "The Density (Iso) method voxelizes density and extracts a surface with marching cubes.",
                "The Ellipsoid method blends analytic ellipsoids with a smooth-min; output mode selects Mesh or SDF.",
            ],
            inputs: &["splats: Splat geometry."],
            outputs: &["out: Mesh or SDF volume."],
            parameters: &[
                ("output", "Output type: Mesh or SDF Volume."),
                ("algorithm", "Method: Density (Iso) or Ellipsoid (Smooth Min)."),
                ...
                ("density_iso", "Density isovalue for marching cubes."),
                ("surface_iso", "Ellipsoid surface threshold."),
                ("bounds_padding", "Padding around bounds in sigmas."),
                ("transfer_color", "Transfer splat color to mesh Cd."),
                ("max_m2", "Exponent clamp for ellipsoid blending."),
                ("smooth_k", "Smooth-min blend sharpness."),
                ("shell_radius", "Shell thickness for ellipsoid method."),
        ...
        "Splat Deform" => Some(NodeHelpPage {
            name: "Splat Deform",
            description: &[
                "Deforms a source splat model using a second input point cloud or splat set.",
                "The node maps splat centers to edited positions and can derive local rotation/scale.",
                "Allow New can create additional splats in stretched regions to fill gaps.",
            ],
            inputs: &["source: Original splats.", "deform: Edited point cloud or splats."],
            outputs: &["out: Deformed splats."],
            parameters: &[
                ("allow_new", "Allow creation of new splats."),
                ("derive_rot_scale", "Infer rotation/scale from deformation."),
            ],
        }),
        "Splat Delight" => Some(NodeHelpPage {
            ...
            parameters: &[
                ...
                ("neutral_color", "Custom neutral lighting color (DC)."),
                ("eps", "Stability epsilon scale."),
                ("ratio_min", "Minimum ratio clamp."),
                ("ratio_max", "Maximum ratio clamp."),
        ...
        "Splat Integrate" => Some(NodeHelpPage {
            ...
            description: &[
                "Relights splats to match a target environment or splat set.",
                "Modes include SH Ratio, Diffuse irradiance, or a Hybrid that keeps higher bands.",
                "Use it to blend scans under different lighting conditions or transfer illumination.",
            ],
            inputs: &[
            ...
            parameters: &[
                ...
                ("source_color", "Custom source lighting color (DC)."),
                ("target_color", "Custom target lighting color (DC)."),
                ("eps", "Stability epsilon scale."),
                ("ratio_min", "Minimum ratio clamp."),
                ("ratio_max", "Maximum ratio clamp."),
                ("high_band_gain", "Gain applied to higher SH bands."),
                ...
                ("output_sh_order", "Output SH order: L0, L1, L2, or L3."),
                ("albedo_max", "Maximum albedo clamp for diffuse relighting."),
        ...
        "Splat Heal" => Some(NodeHelpPage {
            name: "Splat Heal",
            description: &[
                "Fills small gaps in splat surfaces by generating new splats in under-dense regions.",
                "Voxel Close builds a density grid, performs morphological closing, and resplats missing voxels.",
                "SDF Patch samples an ellipsoid SDF band to place splats near the implied surface while skipping occupied voxels.",
            ],
            inputs: &["in: Splat geometry."],
            ...
            parameters: &[
                ...
                ("bounds_padding", "Padding around bounds in sigmas."),
                ("close_radius", "Closing radius in voxels."),
                ("fill_stride", "Subsample candidates (higher = fewer splats)."),
                ("max_new", "Maximum number of new splats."),
                ("sdf_band", "SDF band thickness around the surface."),
                ("sdf_close", "SDF offset to close small gaps."),
                ...
                ("max_m2", "Exponent clamp for SDF method."),
                ("smooth_k", "Smooth-min blend sharpness for SDF method."),
                ("shell_radius", "Ellipsoid shell radius for SDF method."),
                ("blur_iters", "Density blur iterations."),
            ],
        }),
        ...
        "Splat Merge" => Some(NodeHelpPage {
            ...
            description: &[
                ...
                "Feather fades overlapping splats based on distance; Skirt generates new bridging splats.",
            ...
            parameters: &[
                ...
                ("blend_radius", "Blend radius for feathering/fade."),
                ("fade_originals", "Fade original splats near the seam."),
                ("skirt_max_dist", "Maximum distance to bridge with skirt splats."),
                ("skirt_step", "Spacing between skirt splats."),
                ("skirt_max_new", "Maximum skirt splats per pair."),
        ...
        "Copy to Points" => Some(NodeHelpPage {
            name: "Copy to Points",
            description: &[
                "Copies source geometry onto each template point.",
            ...
            inputs: &["source: Geometry to copy.", "template: Points to place copies on."],
            outputs: &["out: Merged copies."],
            parameters: &[
