...
pub fn param_help(node_name: &str, param: &str) -> Option<Cow<'static, str>> {  
    let help = match (node_name, param) {
        ...
        ("Boolean", "mode") => Some("Auto picks mesh-mesh or mesh-SDF; mesh-SDF requires an SDF volume on input B."),
        ("Boolean", "op") => Some("Boolean operation (Union, Difference, Intersect)."),
        ("Boolean", "max_dim") => Some("Maximum voxel dimension for the SDF grid."),
        ("Boolean", "padding") => Some("Padding around the combined bounds."),
        ("Boolean", "surface_iso") => Some("Isovalue used when extracting the output mesh."),
        ("Boolean SDF", "mode") => Some("Auto picks mesh-mesh or mesh-SDF; mesh-SDF requires an SDF volume on input B."),
        ("Boolean SDF", "op") => Some("Boolean operation (Union, Difference, Intersect)."),
        ("Boolean SDF", "max_dim") => Some("Maximum voxel dimension for the SDF grid."),
        ("Boolean SDF", "padding") => Some("Padding around the combined bounds."),
        ("Boolean SDF", "surface_iso") => Some("Isovalue used when extracting the output mesh."),
        ("Boolean Geo", "mode") => Some("Auto picks mesh-mesh or mesh-SDF; mesh-SDF uses an SDF volume on input B as a cutter."),
        ("Boolean Geo", "op") => Some("Boolean operation (Union, Difference, Intersect)."),
        ("File", "path") => Some("Path or URL to an OBJ or glTF file."),
        ("Splat Read", "path") => Some("Path or URL to a splat PLY file."),
        ("Splat Read", "read_mode") => Some("Read full SH data or base color only."),
        ("Read Splats", "path") => Some("Path or URL to a splat PLY file."),
        ...
        ("Splat Outlier", "eps") => Some("Neighborhood radius for density clustering (<=0 = auto)."),
        ("Splat Outlier", "min_pts") => Some("Minimum neighbors for a core point."),
        ("Splat Outlier", "min_cluster_size") => {
            Some("Remove clusters smaller than this size (0 disables).")
        }
        ("Splat Outlier", "group") => Some("Optional group to restrict outlier removal."),
        ("Splat Outlier", "group_type") => Some("Group domain to use."),
        ("Splat Cluster", "method") => Some("Clustering method (Grid or DBSCAN)."),
        ("Splat Cluster", "attr") => Some("Attribute name to store cluster ids."),
        ("Splat Cluster", "cell_size") => Some("Grid cell size (<=0 = auto)."),
        ("Splat Cluster", "eps") => Some("DBSCAN radius (<=0 = auto)."),
        ("Splat Cluster", "min_pts") => Some("Minimum points per DBSCAN core."),
        ("Splat Cluster", "group") => Some("Optional group to restrict clustering."),
        ("Splat Cluster", "group_type") => Some("Group domain to use."),
        ...
        ("Resample", "curve_points") => Some("Target point count per curve."),
        ("Resample", "mesh_ratio") => Some("Target triangle ratio for mesh reduction."),
        ("Resample", "volume_max_dim") => Some("Maximum voxel dimension for resampled volumes."),
        ...
        ("Material", "base_color_tex") => Some("Texture path or URL for base color."),
        ...
        ("Attribute Noise", "noise_type") => Some("Noise basis (Fast/Perlin/Simplex/Worley/etc)."),
        ("Attribute Noise", "fractal_type") => Some("Fractal mode (None/Standard/Terrain/Hybrid)."),
        ("Attribute Noise", "octaves") => Some("Number of fractal octaves."),
        ("Attribute Noise", "lacunarity") => Some("Frequency multiplier per octave."),
        ("Attribute Noise", "roughness") => Some("Amplitude multiplier per octave."),
        ...
        ("Attribute Noise", "flow_rotation") => Some("Perlin Flow rotation (degrees)."),
        ("Attribute Noise", "distortion") => Some("Cloud noise distortion amount."),
        ...
        ("Attribute Promote", "attr") => Some("Attribute name or pattern to promote."),
        ("Attribute Promote", "source_domain") => Some("Class of the source attribute."),
        ("Attribute Promote", "target_domain") => Some("Class to promote into."),
        ("Attribute Promote", "piece_attr") => Some("Optional piece attribute to promote per-piece."),
        ("Attribute Promote", "promotion") => Some("Promotion method for combining values."),
        ("Attribute Promote", "rename") => Some("Enable renaming the promoted attribute."),
        ("Attribute Promote", "new_name") => Some("New attribute name or pattern (* placeholder)."),
        ("Attribute Promote", "delete_original") => Some("Remove the original attribute after promoting."),
