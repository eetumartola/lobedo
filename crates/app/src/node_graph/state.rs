...
pub struct NodeGraphState {
    ...
    pub(super) sam_download: ModelDownloadState,
    pub(super) runtime_download: ModelDownloadState,
    pub(super) directml_download: ModelDownloadState,
...
impl Default for NodeGraphState {
    fn default() -> Self {
        Self {
            ...
            sam_download: ModelDownloadState::default(),
            runtime_download: ModelDownloadState::default(),
            directml_download: ModelDownloadState::default(),
