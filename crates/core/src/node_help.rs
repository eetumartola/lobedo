    ...
    match kind {
        ...
        BuiltinNodeKind::AttributeNoise => Some(NodeHelpPage {
            ...
            description: &[
                ...
                "Supports float/vec2/vec3 outputs, multiple noise bases, and fractal layering.",
                "Use it for masks, variation, or driving downstream operations.",
                "Fractal modes accumulate multiple octaves to add detail.",
            ],
            ...
            parameters: &[
                ...
                (
                    "noise_type",
                    "Noise basis: Fast, Sparse Convolution, Alligator, Perlin, Perlin Flow, Simplex, Worley, Manhattan, Chebyshev, and Cloud variants.",
                ),
                ("fractal_type", "Fractal mode: None, Standard, Terrain, or Hybrid."),
                ("octaves", "Number of fractal octaves."),
                ("lacunarity", "Frequency multiplier per octave."),
                ("roughness", "Amplitude multiplier per octave."),
                ("amplitude", "Noise amplitude."),
                ("frequency", "Noise frequency."),
                ("offset", "Noise space offset."),
                ("seed", "Noise seed."),
                ("flow_rotation", "Perlin Flow rotation in degrees."),
                ("distortion", "Cloud noise distortion amount."),
                ("group", "Restrict to a group."),
                ("group_type", "Group domain to use."),
            ],
        }),
