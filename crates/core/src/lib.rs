...
pub use eval::{
    collect_dirty_nodes, collect_dirty_nodes_full, evaluate_from, evaluate_from_with, node_dirty,
    DirtyNodeReport, DirtyReason, EvalCacheStats, EvalError, EvalNodeReport, EvalReport, EvalState,
};
...
pub use nodes_builtin::{
    ...
    compute_mesh_node, compute_splat_node, default_params, menu_group, node_definition, node_specs,
...
pub use scene::{
    ...
    scene_snapshot_from_splats, SceneCurve, SceneDrawable, SceneMaterial, SceneMesh, SceneSnapshot,
    SceneSplats, SceneVolume, SceneVolumeKind,
};
